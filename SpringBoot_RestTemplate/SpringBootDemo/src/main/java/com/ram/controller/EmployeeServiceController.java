...
public class EmployeeServiceController
{
	...
	{
		System.out.println("Inside updateEmployee method of SpringBootDemo Application");
	...
	{
		System.out.println("Inside getEmployee method of SpringBootDemo Application");
		boolean isEmployeeExist = employeeService.isEmployeeExist(id);
		if (isEmployeeExist)
		{
	...
	{
		System.out.println("Inside getEmployees method of SpringBootDemo Application");
	...
	{
		System.out.println("Inside deleteEmployee method of SpringBootDemo Application");
		boolean isEmployeeExist = employeeService.isEmployeeExist(id);
		if (isEmployeeExist)
		{
